...
int wcfValueSetVecD(wcfClient wcli, const char *field, const double *value, int size){
    auto wcli_ = getWcli(wcli);
    if(!wcli_){
        return 1;
    }
...
const wcfMultiVal *wcfFuncRun(wcfClient wcli,
                         const char *member,
                         const char *field,
                         wcfMultiVal *args,
                         int arg_size){
...
const char *wcfFuncRunS(wcfClient wcli,
                         const char *member,
                         const char *field,
                         const char **args,
                         int arg_size){
