...
Usage: installer.sh [-a|-x] [-y] [-d DIR] [-u] [VERSION]
  ...
  VERSION: Version to install, without 'v' prefix (default: 3.3.1)
           Available versions: 3.3.1 3.3.0 3.2.1 3.2.0 3.1.1-1 3.1.1 2.9.0-1 2.9.0 2.8.0 2.7.0 2.5.2-1 2.5.2 2.5.1 2.5.0-2 2.5.0-1 2.5.0 2.4.2 2.4.1-2 2.4.1-1 2.4.1 2.4.0-1 2.4.0 2.3.0 2.2.1 2.2.0 2.1.0 2.0.5 2.0.4
```
...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v3.3.1/webcface_3.3.1_linux_amd64.zip
sudo unzip webcface_3.3.1_linux_amd64.zip -d /opt/webcface
rm webcface_3.3.1_linux_amd64.zip
...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v3.3.1/webcface_3.3.1_linux_arm64.zip
sudo unzip webcface_3.3.1_linux_arm64.zip -d /opt/webcface
rm webcface_3.3.1_linux_arm64.zip
echo 'export PATH="/opt/webcface/bin:$PATH"' >> ~/.bashrc
...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v3.3.1/webcface_3.3.1_linux_armhf.zip
sudo unzip webcface_3.3.1_linux_armhf.zip -d /opt/webcface
rm webcface_3.3.1_linux_armhf.zip
echo 'export PATH="/opt/webcface/bin:$PATH"' >> ~/.bashrc
...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v3.3.1/webcface_3.3.1_macos_universal.zip
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v3.3.1/webcface-desktop_3.3.1_macos_app.zip
sudo unzip webcface_3.3.1_macos_universal.zip -d /opt/webcface
sudo unzip webcface-desktop_3.3.1_macos_app.zip -d /Applications
rm webcface_3.3.1_macos_universal.zip
rm webcface-desktop_3.3.1_macos_app.zip
