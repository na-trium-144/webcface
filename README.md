...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v2.5.0-1/webcface_2.5.0-1_linux_amd64.zip
sudo unzip webcface_2.5.0-1_linux_amd64.zip -d /opt/webcface
rm webcface_2.5.0-1_linux_amd64.zip
...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v2.5.0-1/webcface_2.5.0-1_linux_arm64.zip
sudo unzip webcface_2.5.0-1_linux_arm64.zip -d /opt/webcface
rm webcface_2.5.0-1_linux_arm64.zip
echo 'export PATH="/opt/webcface/bin:$PATH"' >> ~/.bashrc
...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v2.5.0-1/webcface_2.5.0-1_linux_armhf.zip
sudo unzip webcface_2.5.0-1_linux_armhf.zip -d /opt/webcface
rm webcface_2.5.0-1_linux_armhf.zip
echo 'export PATH="/opt/webcface/bin:$PATH"' >> ~/.bashrc
...
curl -fLO https://github.com/na-trium-144/webcface-webui/releases/download/v1.10.1/webcface-webui_1.10.1_all.deb
curl -fLO https://github.com/na-trium-144/webcface-webui/releases/download/v1.10.1/webcface-desktop_1.10.1_linux_amd64.deb
...
curl -fLO https://github.com/na-trium-144/webcface-webui/releases/download/v1.10.1/webcface-webui_1.10.1_all.deb
curl -fLO https://github.com/na-trium-144/webcface-webui/releases/download/v1.10.1/webcface-desktop_1.10.1_linux_arm64.deb
sudo apt install ./webcface*.deb
rm ./webcface*.deb
```
</details>
...
curl -fLO https://github.com/na-trium-144/webcface-webui/releases/download/v1.10.1/webcface-webui_1.10.1_all.deb
curl -fLO https://github.com/na-trium-144/webcface-webui/releases/download/v1.10.1/webcface-desktop_1.10.1_linux_armv7l.deb
sudo apt install ./webcface*.deb
rm ./webcface*.deb
```
</details>
...
```sh
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v2.5.0-1/webcface_2.5.0-1_macos_universal.zip
curl -fLO https://github.com/na-trium-144/webcface-package/releases/download/v2.5.0-1/webcface-desktop_2.5.0-1_macos_app.zip
```

sudo権限が使用できれば以下のように webcface_universal を /opt/webcface に、 webcface-desktop_app を /Applications に展開するのがおすすめです。
```sh
sudo unzip webcface_2.5.0-1_macos_universal.zip -d /opt/webcface
sudo unzip webcface-desktop_2.5.0-1_macos_app.zip -d /Applications
rm webcface_2.5.0-1_macos_universal.zip
rm webcface-desktop_2.5.0-1_macos_app.zip
```
