...
```sh
curl -LO https://github.com/na-trium-144/webcface/releases/download/v1.7.0/webcface_1.7.0-ubuntu22.04_amd64.deb
...
```sh
curl -LO https://github.com/na-trium-144/webcface/releases/download/v1.7.0/webcface_1.7.0-ubuntu22.04_arm64.deb
...
```sh
curl -LO https://github.com/na-trium-144/webcface/releases/download/v1.7.0/webcface_1.7.0-ubuntu22.04_armhf.deb
...
```sh
curl -LO https://github.com/na-trium-144/webcface/releases/download/v1.7.0/webcface_1.7.0-ubuntu20.04_amd64.deb
curl -LO https://github.com/na-trium-144/webcface-webui/releases/download/v1.4.0/webcface-webui_1.4.0-s_amd64.deb
...
```sh
curl -LO https://github.com/na-trium-144/webcface/releases/download/v1.7.0/webcface_1.7.0-ubuntu20.04_arm64.deb
curl -LO https://github.com/na-trium-144/webcface-webui/releases/download/v1.4.0/webcface-webui_1.4.0-s_arm64.deb
...
```sh
curl -LO https://github.com/na-trium-144/webcface/releases/download/v1.7.0/webcface_1.7.0-ubuntu20.04_armhf.deb
curl -LO https://github.com/na-trium-144/webcface-webui/releases/download/v1.4.0/webcface-webui_1.4.0-s_armhf.deb
