...
struct ResendAlways {
    static bool shouldResend(...) { return true; }
};
struct ResendNever {
    static bool shouldResend(...) { return false; }
};
...
using RobotModelStore =
    SyncDataStore2<const std::vector<internal::RobotLinkData>>;
using ImageStore =
...
extern template class SyncDataStore2<const std::string, int, int>; // test用
extern template class SyncDataStore2<const ValueData, int, std::vector>;
extern template class SyncDataStore2<const TextData, int, int>;
extern template class SyncDataStore2<const FuncData, int, int>;
extern template class SyncDataStore2<const message::ViewData, int, int>;
extern template class SyncDataStore2<const RobotModelData, int>;
extern template class SyncDataStore2<const message::Canvas3DData, int>;
extern template class SyncDataStore2<const message::Canvas2DData, int>;
extern template class SyncDataStore2<const ImageData, message::ImageReq>;
extern template class SyncDataStore2<LogHistory, int>;
#endif
