...
# target = webcface-magickpp-linker
...
if(NOT CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    ...
    if(Magickpp_FOUND)
        ...
        target_include_directories(webcface-magickpp-linker INTERFACE ${Magickpp_INCLUDE_DIRS})
        target_compile_options(webcface-magickpp-linker INTERFACE ${Magickpp_CFLAGS_OTHER})
        target_link_directories(webcface-magickpp-linker INTERFACE ${Magickpp_LIBRARY_DIRS})
        target_link_libraries(webcface-magickpp-linker INTERFACE ${Magickpp_LIBRARIES})
...
if(WEBCFACE_FIND_MAGICK AND CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    ...
    if(Magickpp_FOUND)
        ...
        add_library(webcface-magickpp-linker INTERFACE)
        target_include_directories(webcface-magickpp-linker INTERFACE ${MAGICKPP_WIN_INCLUDE_DIR})
