...
endforeach()
list(APPEND WEBCFACE_CMAKE_PROPS "-DCMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES}")

list(APPEND WEBCFACE_CMAKE_PROPS "-DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH}")
